...
public class NumMaxIVs extends SpecValue<Integer> implements ISpecType {
    ...
    public boolean matches(NBTTagCompound nbt) {
        return this.count31s(new int[]{nbt.getByte("IVHP"), nbt.getByte("IVAttack"), nbt.getByte("IVDefence"), nbt.getByte("IVSpAtt"), nbt.getByte("IVSpDef"), nbt.getByte("IVSpeed")}) >= this.value;
    }
